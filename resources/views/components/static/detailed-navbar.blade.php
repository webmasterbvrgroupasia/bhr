...
<nav x-data="{
    openNavbar: false
}" class="absolute px-2 w-full py-4 grid md:grid lg:hidden grid-cols-2 items-center">
    <div class="col-span-1">
        <img src="{{ asset('images/logo-bhr-white.png') }}" class="w-44 md:w-52" alt="">
    </div>
    ...
    <div class="col-span-2 bg-white mt-2 text-sm font-medium z-50" x-cloak x-transition x-show="openNavbar">
