<footer class="w-full py-16 lg:py-8 px-2 bg-gray-50 border-t-[1px]">
    ...
    <div class="grid grid-cols-12 gap-y-12 md:gap-x-5 lg:gap-x-10 max-w-full md:max-w-5xl mx-auto">
        <div class="col-span-12 md:col-span-6 space-y-[20px]">
            <img src="{{ asset('images/logo-bhr.png') }}" class="w-44" alt="BVR Bali Holiday Rentals">
        ...
        <div class="col-span-12 flex justify-start">
            <div class="space-y-[16px]">
                ...
                <a href="https://www.bvrgroupasia.com" target="_blank">
                    <img src="{{asset('images/bvr-group-asia.png')}}" class="w-20 mt-2 block" alt="BVR Group Asia">
                </a>
                <div class="flex space-x-4">
                    <a href="https://www.bvrproperty.com" target="_blank">
                        <img src="{{asset('images/bvr-property.png')}}" class="w-16 mt-2" alt="BVR Property">
                    </a>
                    <a href="https://www.bvrgroupasia.com" target="_blank">
                        <img src="{{asset('images/grand-land-corp.png')}}" class="w-16 mt-2" alt="Grand Land Corp">
                    </a>
                    <a href="https://www.bvrgroupasia.com" target="_blank">
        ...
        <div class="col-span-12 flex items-center justify-center text-gray-500 border-t-[1px] pt-8 gap-x-[8px]">
            Powered by <a href="https://www.bvrdigital.com"><img src="{{asset('images/digital-logo.webp')}}" alt="BVR Digital" class="w-24"/> </a>
        </div>
    </div>
