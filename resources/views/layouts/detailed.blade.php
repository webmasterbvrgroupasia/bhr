...
<body class="bg-white">
    ...
    <a href="https://wa.me/6285738930043" target="_blank"
        class="z-50 fixed bg-white rounded-full bottom-5 right-5 flex text-gray-600 items-center text-xs space-x-[8px] w-fit">
        <div>
