...
<body class="bg-white">
    ...
    <a href="https://wa.me/6285738930043" target="_blank" class="z-50 fixed bg-white rounded-full bottom-20 right-20 flex text-gray-600 items-center text-xs space-x-[8px] w-fit">
        <div>
    ...
    <a href="/properties" target="_blank"
