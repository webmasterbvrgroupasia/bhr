...
@section('page-content')
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Add New Areas</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <form enctype="multipart/form-data" method="POST" enctype="multipart/form-data"
        action="{{ route('areas.store') }}"class="grid grid-cols-12 gap-x-5 mt-4 px-5 md:px-8 lg:px-[100px] gap-y-5">
        @csrf
        <div class="col-span-12">
            <label for="location" class="font-semibold">Area Name</label>
            <input type="text" name="location" id="location" placeholder="e.g Ubud"
        ...
        <div class="col-span-12">
            ...
            <input type="text" name="slug" id="slug" placeholder="e.g ubud"
                class="block w-1/3 py-2 px-2 mt-3 rounded-md">
        </div>
