...
@section('page-content')
    ...
    @if (Session::has('success-add'))
        <div id="toast-success"
            ...
            <div class="ml-3 text-sm font-normal">{{session()->get('success-add')}}</div>
            <button type="button"
    ...
    <section class="grid grid-cols-12 px-5 md:px-12 lg:px-[100px] gap-x-5 gap-y-10 mt-4">
        ...
        <div class="col-span-12 flex items-center justify-end pb-4">
            ...
            <form action="/admin/areas/search" method="GET">
                    ...
                    <tbody>
                        @foreach ($areas as $area)
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    {!! Str::limit($area->description, 75) !!}
                                </td>
                                <td class="px-6 py-4 flex space-x-4">
                                    <a href="{{ route('areas.edit', $area->id) }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                    <form class="text-red-600 font-medium" method="POST" action="{{ route('areas.destroy', $area->id) }}">
                                        @csrf
                                        @method('delete')
