...
@section('page-content')
    ...
    <form enctype="multipart/form-data" method="POST" enctype="multipart/form-data"
        action="{{ route('blogpost.store') }}"class="grid grid-cols-12 gap-x-5 mt-4 px-5 md:px-8 lg:px-[100px] gap-y-5">
        @csrf
        <div class="col-span-12">
            <label for="location" class="font-semibold">Blogpost Title</label>
            <input type="text" name="title" id="title" placeholder="e.g Ubud"
                class="block w-1/3 py-2 px-2 mt-3 rounded">
        </div>
        <div class="col-span-12">
