...
@section('page-title', 'Blogpost Management')
...
@section('page-content')
    ...
    @if (Session::has('success-delete'))
        <div id="toast-danger"
            ...
            <div class="ml-3 text-sm font-normal">Blogpst has been deleted.</div>
            <button type="button"
    ...
    @if (Session::has('success'))
        <div id="toast-success"
            ...
            <div class="ml-3 text-sm font-normal">Blogpost added successfully.</div>
            <button type="button"
    ...
    @if (Session::has('update-success'))
        <div id="toast-success"
            ...
            <div class="ml-3 text-sm font-normal">Blogpost updated successfully.</div>
            <button type="button"
                class="ml-auto -mx-1.5 -my-1.5 text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                data-dismiss-target="#toast-success" aria-label="Close">
                <span class="sr-only">Close</span>
    ...
    <section class="grid grid-cols-12 px-5 md:px-12 lg:px-[100px] gap-x-5 gap-y-10 mt-4">
        ...
        @else
            <div class="col-span-12 flex items-center justify-end pb-4">
                ...
                <form action="/admin/blogposts/search" method="GET">
                            ...
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 flex items-center space-x-4">
                                    ...
                                    <a href="{{ route('blogpost.show', $post->id) }}"
                                        class="font-medium text-gray-600 dark:text-blue-500 hover:underline">Details</a>
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                        Are you sure you want to delete this property?</h3>
                                                    <form method="POST"
                                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                                                        action="{{ route('blogpost.destroy', $post->id) }}">
                                                        @csrf
                                                        @method('delete')
