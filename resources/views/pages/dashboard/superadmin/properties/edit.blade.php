...
@section('page-content')
    ...
    <section class="w-full py-12 text-gray-900" x-data="{
        ...
        <div class="max-w-4xl p-5 bg-white drop-shadow-md mx-auto space-y-[16px] h-[75vh] overflow-y-scroll">
            ...
            <h4 class="text-xl font-bold dark:text-white">Edit {{$property->name}}</h4>

            <form action="{{ route('properties.update',$property->id) }}" method="POST" class="grid grid-cols-4 gap-5"
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" id="booking_link" name="booking_link"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{$property->booking_link}}" required>
                </div>
                <div class="col-span-2">
                ...
                <div class="col-span-4">
                    ...
                    <textarea name="description"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        id="" cols="30" rows="10">{{$property->description}}</textarea>
                </div>
                <div class="col-span-2">
                ...
                <div class="col-span-2">
                    ...
                    <input
                        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                        id="images" name="images[]" type="file" value="{{$property->images}}" multiple>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="pool-1" type="radio" value="1"  {{ $property->pool == '1' ? 'checked' : '' }}
                             name="pool"
                        ...
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="pool-2" type="radio" value="0" name="pool" {{ $property->pool == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="pool-2"
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="bar-1" type="radio" value="1" name="bar" {{ $property->bar == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="bar-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="bar-2" type="radio" value="0" name="bar" {{ $property->bar == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="bar-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="sauna-1" type="radio" value="1" name="sauna" {{ $property->sauna == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="sauna-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="sauna-2" type="radio" value="0" name="sauna" {{ $property->sauna == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="sauna-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        ...
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="hot-tub-2" type="radio" value="0" name="hot_tub" {{ $property->hot_tub == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="hot-tub-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="garden-1" type="radio" value="1" name="garden" {{ $property->garden == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="garden-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="garden-2" type="radio" value="0" name="garden" {{ $property->garden == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="garden-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="non-smoking-room-1" type="radio" value="1" name="non_smoking_room" {{ $property->non_smoking_room == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="non-smoking-room-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="non-smoking-room-2" type="radio" value="0" name="non_smoking_room" {{ $property->non_smoking_room == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="family-room-1" type="radio" value="1" name="family_room" {{ $property->family_room == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="family-room-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="family-room-2" type="radio" value="0" name="family_room" {{ $property->family_room == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="jacuzzi-1" type="radio" value="1" name="jacuzzi" {{ $property->jacuzzi == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="jacuzzi-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="jacuzzi-2" type="radio" value="0" name="jacuzzi" {{ $property->jacuzzi == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="jacuzzi-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="air-conditioner-1" type="radio" value="1" name="air_conditioning" {{ $property->air_conditioning == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="air-conditioner-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="air-conditioner-2" type="radio" value="0" name="air_conditioning" {{ $property->air_conditioning == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="balcony-1" type="radio" value="1" name="balcony" {{ $property->balcony == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="balcony-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="balcony-2" type="radio" value="0" name="balcony" {{ $property->balcony == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="balcony-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="tv-1" type="radio" value="1" name="tv" {{ $property->tv == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="tv-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="tv-2" type="radio" value="0" name="tv" {{ $property->tv == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="tv-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="electric-kettle-1" type="radio" value="1" name="electric_kettle" {{ $property->electric_kettle == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="electric-kettle-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="electric-kettle-2" type="radio" value="0" name="electric_kettle" {{ $property->electric_kettle == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="clothes-rack-1" type="radio" value="1" name="clothes_rack" {{ $property->clothes_rack == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="clothes-rack-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="clothes-rack-2" type="radio" value="0" name="clothes_rack" {{ $property->clothes_rack == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="hair-dryer-1" type="radio" value="1" name="hair_dryer" {{ $property->hair_dryer == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="hair-dryer-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="hair-dryer-2" type="radio" value="0" name="hair_dryer" {{ $property->hair_dryer == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    <label for="safety-box"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Safety Deposit Box</label>
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="safety-box-1" type="radio" value="1" name="safety_box" {{ $property->safety_box == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="safety-box-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="safety-box-2" type="radio" value="0" name="safety_box" {{ $property->safety_box == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="desk-1" type="radio" value="1" name="desk" {{ $property->desk == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="desk-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="desk-2" type="radio" value="0" name="desk" {{ $property->desk == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="desk-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="socket-1" type="radio" value="1" name="socket"  {{ $property->socket == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="socket-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="socket-2" type="radio" value="0" name="socket"  {{ $property->socket == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="socket-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="private-entrance-2" type="radio" value="1" name="private_entrance"  {{ $property->private_entrance == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="private-entrance-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="private-entrance-2" type="radio" value="0" name="private_entrance"  {{ $property->private_entrance == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="private-entrance-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="private-bathroom-2" type="radio" value="1" name="private_bathroom" {{ $property->private_bathroom == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="private-bathroom-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="private-bathroom-2" type="radio" value="0" name="private_bathroom" {{ $property->private_bathroom == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="private-bathroom-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="toilet-paper-1" type="radio" value="1" name="toilet_paper" {{ $property->toilet_paper == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="toilet-paper-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="toilet-paper-2" type="radio" value="0" name="toilet_paper" {{ $property->toilet_paper == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="shower-1" type="radio" value="1" name="shower" {{ $property->shower == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="shower-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="shower-2" type="radio" value="0" name="shower" {{ $property->shower == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="shower-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="bathtub-1" type="radio" value="1" name="bathtub" {{ $property->bathtub == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="bathtub-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="bathtub-2" type="radio" value="0" name="bathtub" {{ $property->bathtub == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="bathtub-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="slipper-1" type="radio" value="1" name="slipper" {{ $property->slipper == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="slipper-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="slipper-2" type="radio" value="0" name="slipper" {{ $property->slipper == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="slipper-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="toileteries-1" type="radio" value="1" name="toileteries" {{ $property->toileteries == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="toileteries-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="toileteries-2" type="radio" value="0" name="toileteries" {{ $property->toileteries == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="minibar-1" type="radio" value="1" name="minibar" {{ $property->minibar == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="minibar-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="minibar-2" type="radio" value="0" name="minibar" {{ $property->minibar == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="minibar-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">No</label>
                        </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="refrigerator-1" type="radio" value="1" name="refrigerator" {{ $property->refrigerator == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="refrigerator-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="refrigerator-2" type="radio" value="0" name="refrigerator" {{ $property->refrigerator == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="tea-coffee-maker-1" type="radio" value="1" name="tea_coffee_maker" {{ $property->tea_coffee_maker == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="tea-coffee-maker-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="tea-coffee-maker-2" type="radio" value="0" name="tea_coffee_maker" {{ $property->tea_coffee_maker == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="smoke-alarm-1" type="radio" value="1" name="smoke_alarm" {{ $property->smoke_alarm == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="smoke-alarm-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="smoke-alarm-2" type="radio" value="0" name="smoke_alarm" {{ $property->smoke_alarm == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="fire-extinguisher-1" type="radio" value="1" name="fire_extinguisher" {{ $property->fire_extinguisher == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="fire-extinguisher-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Yes</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="fire-extinguisher-2" type="radio" value="0" name="fire_extinguisher" {{ $property->fire_extinguisher == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="col-span-4">
                    ...
                    <div class="grid grid-cols-2 gap-2 w-full">
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="property-status-1" type="radio" value="1" name="property_status" {{ $property->property_status == '1' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="property-status-1"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Live</label>
                        </div>
                        <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="property-status-2" type="radio" value="0" name="property_status" {{ $property->property_status == '0' ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="property-status-2"
                                class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Not Live</label>
                        </div>
                    </div>
                </div>
