...
@section('page-content')
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('properties.show',$property->id) }}"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{$property->name}}</a>
                    </div>
                </li>
    ...
    <form enctype="multipart/form-data" method="POST" enctype="multipart/form-data"
        action="{{ route('room-type.store') }}"class="grid grid-cols-12 gap-x-5 mt-4 px-5 md:px-8 lg:px-[100px] gap-y-5">
        @csrf
        <div class="col-span-4">
            <label for="name" class="font-semibold">Room Type Name</label>
            <input type="text" name="name" id="name" placeholder="e.g Deluxe Room with Pool View" required
        ...
        <div class="col-span-4">
            ...
            <input type="num" name="room_area" placeholder="145.4" required
        ...
        <div class="col-span-4">
            ...
            <input type="num" name="maximum_adult" placeholder="2" required
                class="block w-full py-2 px-2 mt-3 rounded-md border-[1px] border-neutral-500">
        </div>
        <div class="col-span-4">
        ...
        <div class="col-span-6">
            ...
            <input type="num" name="maximum_adult" placeholder="IDR 2,400,000" required
                class="block w-full py-2 px-2 mt-3 rounded-md border-[1px] border-neutral-500">
        </div>
        <div class="col-span-12">
            <button type="submit"
