    ...
    <section class="px-2 py-8 md:py-8 lg:pb-16 max-w-full md:max-w-3xl lg:max-w-5xl mx-auto space-y-[64px]" itemscope>
        <div class="space-y-4 w-full lg:w-8/12">
            <div class="space-y-2">
                ...
                <p class="text-base text-neutral-500 w-full md:w-full" itemprop="description">
                    {{ $offer->description }}
                </p>
            </div>
            <div class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                @foreach ($relatedImage as $image)
                    ...
                    <div class="">
                        ...
                        <img src="{{ asset('storage/' . $image) }}" alt="{{$offer->package_name}}" title="{{$offer->package_name}}" class="h-44 w-full object-cover" itemprop="images">
            ...
            <div class="space-y-4">
                <div>
                    <a class="w-full text-center text-sm block bg-[#ff5700] text-white hover:text-[#ff5700] hover:bg-white transition py-2.5" title="Book Now!"
