    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        @if (count($special_offers)>0)
            ...
            <div class="border bg-white hover:drop-shadow-md transition">
                <img src="{{asset('storage/'.$offer->image)}}" class="h-44 w-full object-cover" alt="">
                <div class="p-4 space-y-2">
                    <h3 class="font-semibold text-neutral-800">
                        {{$offer->package_name}}
                    </h3>
                    <a class="text-[#ff5700] font-normal text-sm flex w-fit items-center space-x-1" href="{{route('offer.detail',$offer->slug)}}">
                        <div>
                            More Details
                        </div>
                        <div>
