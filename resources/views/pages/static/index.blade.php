            ...
            <div class="grid grid-cols-3 gap-5">
                @foreach ($properties as $property)
                    @if ($property->images != '')
                        ...
                        @endphp
                        <div class="col-span-3 md:col-span-1 border bg-white" itemprop="properties">
                            ...
                            <div class="font-semibold mt-4  px-5 pb-5">
                                ...
                                <a href="/properties/{{ $property->slug }}" class="block font-medium text-blue-600" title="More Details">View
                                    More Details</a>
                            </div>
                        </div>
                    @endif
